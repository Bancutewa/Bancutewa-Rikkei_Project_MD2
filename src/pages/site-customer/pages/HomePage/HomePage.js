            ...
            <div className='container elementor '>
                ...
                <section className='elementor-section'>
                    <div className='category'>
                        ...
                        <div className='products'>
                            {products
                                .filter(product => product.category === "Cá Dĩa")
                                .slice(0, 4)
                                .map(product => (
                                    <Card key={product.id} product={product} />
                                ))}
                ...
                <section className='elementor-section'>
                    <div className='category'>
                        ...
                        <div className='products'>
                            {products
                                .filter(product => product.category === "Cá Cầu Vồng")
                                .slice(0, 4)
                                .map(product => (
                                    <Card key={product.id} product={product} />
                                ))}
                ...
                <section className='elementor-section'>
                    <div className='category'>
                        <h2>Cá Phượng Hoàng</h2>
                        <div className='products'>
                            {products
                                .filter(product => product.category === "Cá Phượng Hoàng")
                                .slice(0, 4)
                                .map(product => (
                                    <Card key={product.id} product={product} />
                                ))}
                ...
                <section className='elementor-section'>
                    <div className='category'>
                        ...
                        <div className='products'>
                            {products
                                .filter(product => product.category === "Thức Ăn Cá")
                                .slice(0, 4)
                                .map(product => (
                                    <Card key={product.id} product={product} />
                                ))}
                ...
                <section className='elementor-section'>
                    <div className='category'>
                        ...
                        <div className='products'>
                            {products
                                .filter(product => product.category === "Tép Thủy Sinh")
                                .slice(0, 4)
                                .map(product => (
                                    <Card key={product.id} product={product} />
                                ))}
